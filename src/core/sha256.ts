// Pure-JS SHA-256 (FIPS 180-4). The core imports no module (I1), and there is no hash port
// (20-contract.md §4) — one payload has one digest regardless of who loads it (I5, I13).
...
export function sha256Hex(text: string): string {
  ...
  // bitLen fits in 32 bits for any realistic payload; the high 32 bits of the length are 0.
